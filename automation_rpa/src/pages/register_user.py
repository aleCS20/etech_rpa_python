...
class RegisterPage(BasePage):
    """
    Especialização da página de registro. 
    Contém os seletores mapeados (Locators) e as ações específicas do Test Case 1.
    """

    # --- Seletores (Locators) ---
    # Passo 4 e 5: Login/Signup Inicial
    SIGNUP_LOGIN_LINK = (By.CSS_SELECTOR, "a[href='/login']")
    NEW_USER_TEXT     = (By.XPATH, "//h2[contains(text(), 'New User Signup!')]")
    
    # Passo 6: Cadastro Rápido (Initial Signup)
    ...
    # Passo 8: Verificação de Formulário Detalhado
    ACCOUNT_INFO_TEXT = (By.XPATH, "//b[contains(text(), 'Enter Account Information')]")
    
    # Passo 9 a 11: Detalhes da Conta
    ...
    # Passo 16 e 17: Pós-Login e Deleção
    LOGGED_IN_TEXT     = (By.XPATH, "//i[@class='fa fa-user']/parent::a")
    ...
    def preencher_detalhes_pessoais(self, senha, dia, mes, ano):
        ...
        self.select_dropdown_by_value(self.MONTHS_SELECT, mes)
    ...
    def preencher_endereco_e_criar(self, mock):
        """Recebe a instância da classe MockDados"""
    ...
    def confirmar_e_deletar(self):
        ...
        # Retorna o texto do header para validar o "Logged in as..."
